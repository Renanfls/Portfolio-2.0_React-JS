    ...
    return (
        <section id="about" className=" w-100">
            <Row className="d-flex justify-content-center">
                <Col sm={12} md={8} xl={6} className="d-flex justify-content-center align-items-center">
                    <img id="pictureAbout" className="h-100 w-75" src="/images/picture.jpg" alt="foto"/>
                </Col>
                <Col sm={12} md={8} xl={6} className="align-items-center justify-content-center my-5 my-xl-0 d-flex">
                    <div>
                        ...
                        <div className="description my-4">
                            ...
                            <Row className="d-flex justify-content-center m-4">
                                {about.formations.map(formation => 
                                    <Col sm={12} md={5} className="formations mb-3 mb-md-0 me-md-2 p-3 rounded-5">
                        ...
                        <div className="containerTools align-items-center d-flex flex-column">
                            <ul className="tools">
                                {tools.line1.map(tool =>
                                    <li><img src={tool.src} alt={tool.alt} className="w-100"/></li>
                                )}
                            </ul>
                            <ul className="tools">
                                {tools.line2.map(tool =>
                                    <li><img src={tool.src} alt={tool.alt} className="w-75"/></li>
                                )}
                            </ul>
                            <ul className="tools">
